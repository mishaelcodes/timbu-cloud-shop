...
const CartComponent = () => {
  ...
  return (
    <div className="w-[85%] mx-auto mb-5 font-semibold">
      ...
      <div className="border-2 border-timbuGrey rounded-md mt-14 p-[10px]">
        ...
        <form className="flex items-center justify-evenly mb-3">
          <label htmlFor="promoCode">
            ...
            <input
              type="text"
              id="promoCode"
              className="p-3 border-2 border-timbuGrey rounded-md w-56 mt-2"
              placeholder="Promo code"
            />
          </label>
          <div className=" self-end">
            <Button content="Apply" width="w-fit" padding="py-4 px-7" />
          </div>
        </form>
